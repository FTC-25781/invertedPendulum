...
@TeleOp(name = "objectTracking OpMode", group = "Computer Vision")
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (yellowBlockDetected) {
                double horizontalServoPosition = mapToServoRange(detectedBlockX, 0, 640, 0, 1);
                horizontalServo.setPosition(horizontalServoPosition);

                double verticalServoPosition = mapToServoRange(detectedBlockY, 0, 480, 0, 1);
